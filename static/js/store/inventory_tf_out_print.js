...
.then(data => {
    ...
    document.getElementById('noTfOut').innerText = data.data.no_do;
    document.getElementById('titleDoc').innerText = `Transfer Out Doc (${data.data.no_do})`;
    ...
    document.getElementById('tanggalTfOut').innerText = tanggalFinal;
